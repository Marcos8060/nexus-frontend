    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <select
          ...
          className="px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-md bg-background"
        >
          ...
          {loading ? (
            ...
            <div className={`grid gap-4 ${viewMode === 'grid' ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1'}`}>
              {filteredInterviews.map((interview) => (
                <Card key={interview.id} className="hover:shadow-lg transition-all duration-200 group" data-testid="interview-card">
